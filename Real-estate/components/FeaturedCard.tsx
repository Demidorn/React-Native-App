  ...
  return (
    ...
    >
      ...
      <View className='absolute top-3 left-3 bg-white /90 px-3 py-1 rounded-full'>
        <Text className='text-sm font-semibold  text-blue-600  capitalize'>{property.type}</Text>
      </View>
      {/* sold property */}
      {property.is_sold && (
      ...
      <View className='p-4'>
        ...
        <View className='flex-row items-center gap-1  mb-3'>
          ...
          <Text className='text-ts text-gray-500' numberOfLines={1}>{property.address}, {property.city}</Text>
        </View>
