...
import { Text, TouchableOpacity, View, Image, ActivityIndicator, Alert, Linking } from "react-native";
  ...
  return (
    <SafeAreaView className="flex-1 bg-white mb-10">
      <View className='items-center py-8'>
        ...
        <Text className="text-xl font-bold text-gray800">{user.firstName} {user.lastName}</Text>
        <Text className='text-gray500 mt-1'>
